...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '若依科技',   0, '德银ETC', '15888888888', 'dyetc@qq.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept values(101,  100, '0,100',      '深圳总公司', 1, '德银ETC', '15888888888', 'dyetc@qq.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept values(102,  100, '0,100',      '长沙分公司', 2, '德银ETC', '15888888888', 'dyetc@qq.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, '德银ETC', '15888888888', 'dyetc@qq.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, '德银ETC', '15888888888', 'dyetc@qq.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, '德银ETC', '15888888888', 'dyetc@qq.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, '德银ETC', '15888888888', 'dyetc@qq.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, '德银ETC', '15888888888', 'dyetc@qq.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, '德银ETC', '15888888888', 'dyetc@qq.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, '德银ETC', '15888888888', 'dyetc@qq.com', '0', '0', 'admin', sysdate, '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '德银ETC', '00', 'dyetc@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate, 'admin', sysdate, '', null, '管理员');
insert into sys_user values(2,  105, 'de',    '德银ETC', '00', 'dyetc@qq.com',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate, 'admin', sysdate, '', null, '测试员');
...
insert into sys_menu values('4', '若依官网', '0', '4', 'http://dyetc.vip', null, '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate, '', null, '若依官网地址');
-- 二级菜单
...
insert into sys_job values(1, '系统默认（无参）', 'DEFAULT', 'dyEtcTask.deNoParams',        '0/10 * * * * ?', '3', '1', '1', 'admin', sysdate, '', null, '');
insert into sys_job values(2, '系统默认（有参）', 'DEFAULT', 'dyEtcTask.deParams(''de'')',  '0/15 * * * * ?', '3', '1', '1', 'admin', sysdate, '', null, '');
insert into sys_job values(3, '系统默认（多参）', 'DEFAULT', 'dyEtcTask.deMultipleParams(''de'', true, 2000L, 316.50D, 100)',  '0/20 * * * * ?', '3', '1', '1', 'admin', sysdate, '', null, '');
